...
(function() {
    ...
    var loadPlugin = function(cb, eb) {
        ...
        if (!window.auditRunner) {
            ...
            scriptTag.src = '//raw.githubusercontent.com/dsathyakumar/a11y-auditor/master/dist/a11y-auditor.js';
        } else {
    ...
    var chaiAccessibility = function(chai, utils, modules) {
        ...
        Assertion.addMethod('accessible', function(config, executeGlobalRules) {
            ...
            loadPlugin(function() {
                ...
                // Run the auditor
                var response = window.auditRunner(element.get(0), config.ignore, executeGlobalRules);
