...
// ## `chai-accessibility` plugin implementation for browsers.
'use strict';
var $ = require('jquery');
...
var loadPlugin = function (cb, eb) {
  if (!window.axs) {
    ...
    scriptTag.src = '//raw.github.com/GoogleChrome/accessibility-developer-tools/stable/dist/js/axs_testing.js';
  } else {
